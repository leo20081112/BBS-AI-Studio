...
**BBS AI Studio** 是 [BBS FS](https://github.com/Wemppy4/bbs-fs)（Fabric 1.20.1 的 Minecraft 动画 Mod）的 Fork，在完全兼容原版 BBS 插件生态的前提下，新增 **AI 驱动的动画制作能力**，并重构 UI/UX 体验。
...
1. 将 Mod 安装到 Fabric 1.20.1 环境并启动游戏。
