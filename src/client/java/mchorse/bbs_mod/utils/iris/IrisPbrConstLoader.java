 ...
 */
public class IrisPbrConstLoader implements PBRTextureLoader<IrisPbrConstWrapper>
{
     ...
     */
    private final LinkedHashMap<String, Texture> normalCache = new LinkedHashMap<>();

    @Override
    public void load(IrisPbrConstWrapper wrapper, ResourceManager resourceManager, PBRTextureConsumer pbrTextureConsumer)
    {
        ...
        if (wrapper.relief > 0F)
        {
            ...
            if (normal == null)
            {
                ...
                if (normal != null)
                {
                    ...
                    Iterator<Texture> it = this.normalCache.values().iterator();
    ...
    public static class SharedTexture extends IrisPbrTexture
    {
    ...
    /**
     * A vanilla texture over one of our generated GL textures. The PBR holder owns it: when Iris
     * closes the holder (the albedo variant died), the GL texture goes with it.
     */
    public static class StaticTexture extends IrisPbrTexture
    {
        private final Texture texture;
