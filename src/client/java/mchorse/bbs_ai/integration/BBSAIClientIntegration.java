...
public class BBSAIClientIntegration
{
    ...
    /**
     * KeyBinding 分类（【1.21.11 适配】分类改用 Category 对象而非字符串）
     */
    private static final KeyBinding.Category AI_KEY_CATEGORY = KeyBinding.Category.create(net.minecraft.util.Identifier.of(BBSMod.MOD_ID, "ai"));
